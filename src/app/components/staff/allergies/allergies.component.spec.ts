...
import { AllergiesSearchDialogComponent } from '../../dialog/allergies/search-for-staff/allergies-dialog-search.component';
import { SearchAllergyDTO } from '../../../models/allergy/searchAllergyDTO';
import { AllergiesStaffComponent } from './allergies.staff.component';
...
describe('AllergiesStaffComponent', () => {
  let component: AllergiesStaffComponent;
  let fixture: ComponentFixture<AllergiesStaffComponent>;
  let mockService: MockAllergiesService;
  let mockDialog: MockMatDialog;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MatTableModule, AllergiesStaffComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(AllergiesStaffComponent);
